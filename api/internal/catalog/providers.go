...
var providers = []Provider{
	...
	},
	{
		...
		Description:      "Servidor de Terraria, vanilla ou TShock.",
		...
		StopGraceSeconds: 60,
		Fields: []Field{
			{Key: "WORLD_FILENAME", Label: "Arquivo do mundo", Type: FieldText,
				Help: "Nome de um .wld já presente em ./data. Vazio cria um mundo novo."},
			{Key: "AUTOCREATE", Label: "Tamanho do mundo novo", Type: FieldEnum, Default: "2",
				Options: opts("1", "Pequeno", "2", "Médio", "3", "Grande")},
			{Key: "WORLD_NAME", Label: "Nome do mundo novo", Type: FieldText, Default: "GameDock"},
	...
	},
	{
		...
		Fields: []Field{
			...
			{Key: "AUTOSAVEINTERVAL", Label: "Intervalo de autosave (s)", Type: FieldInt, Default: "300", Min: ptr(60), Advanced: true},
		},
	},
	{
		ID:               CustomProviderID,
